// Auxiliar para carregar e indexar JSONs de mapeamento por modelo produzidos da análise
...
export function indexMapping(mapping) {
  ...
  const byMaterialUuid = new Map(); // uuid -> entrada
  ...
  // Também agrupa meshes por nome de material original (mesma estrutura do mapeamento)
